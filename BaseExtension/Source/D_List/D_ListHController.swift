...
/**
 D_ListHController helps register, dequeues, and sets up cells with their respective items to render in a standard single section list.
 ## Generics ##
 ...
 */
open class D_ListHController<C: D_ListCell<CI>, CI, H: D_ListHeader<HI>, HI>: UICollectionViewController {
    ...
    required public init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of D_ListHController or sublasses of this component from your Storyboard files.")
    }
