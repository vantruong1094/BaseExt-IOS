...
extension UIView {
    ...
    @discardableResult
    public func addScrollView(_ scrollView: D_ScrollView, withSafeArea: D_ViewSafeArea = .none, hasStatusBarCover: Bool = false, statusBarBackgroundColor: UIColor = .white, container: UIStackView, elements: UIView...) -> UIView {
