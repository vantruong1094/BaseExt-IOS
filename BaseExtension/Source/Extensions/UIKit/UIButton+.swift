...
extension PressButton {
    open func backgroundColor(_ highLightColor: UIColor, _ unHighLightColor: UIColor) -> PressButton {
        bgHighLightColor = highLightColor
        bgUnHighLightColor = unHighLightColor
        return self
    }
    
    open func titleColor(_ highLightColor: UIColor, _ unHighLightColor: UIColor) -> PressButton {
        titleHighLightColor = highLightColor
        titleUnHighLightColor = unHighLightColor
        return self
    }
}
