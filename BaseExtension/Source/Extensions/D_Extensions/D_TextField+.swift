...
extension D_TextField {
    ...
    @discardableResult
    open func font(_ font: UIFont) -> D_TextField {
        self.font = font
        return self
    }
    ...
    @discardableResult
    open func placeholderColor(_ color: UIColor) -> D_TextField {
    ...
    @discardableResult
     open func setBorderStyle(_ style: UITextField.BorderStyle) -> UITextField {
